            ...
            <v-container fluid>
                ...
                <v-card class="mx-auto mb-5" max-width="1200">
                         <v-card-text>
                             ...
                             <p class="subtitle-1">
                                 หวังเป็นอย่างยิ่งว่า เว็บไซต์นี้จะตอบโจทก์ในการค้นหาโอวาทหลวงพ่อธัมมชโย เพื่อนำไปใช้งานสำหรับท่านที่สนใจ หากท่านใดมีข้อเสนอแนะเพื่อการพัฒนาโปรแกรมก็สามารถส่งคำแนะนำมาได้ ขอขอบคุณและอนุโมทนาบุญมา ณ โอกาสนี้
                             </p>
                         </v-card-text>
                     </v-card>
