...
console.log('ShortsListV2 (Naive UI) component loaded!')
...
const loadMoreResults = async (): Promise<void> => {
  ...
  try {
    ...
    console.log('More shorts loaded:', {
      newTotal: shortsData.value.length,
      remaining: totalResults.value - shortsData.value.length,
...
const performSearch = (): void => {
  ...
  try {
    ...
    console.log('Search performed on shorts:', {
      keywords: searchKeywords.value,
      results: filteredShorts.value.length
    })
  } catch (error) {
